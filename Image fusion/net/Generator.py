...
class Generator(torch.nn.Module):
    def __init__(self,in_channles=3,features=64):
        ...
        self.up3 = Block(in_channels=features * 8*2, out_channels=features * 4, down=False, act="relu", use_dropout=False)
        self.up4 = Block(in_channels=features * 4*2, out_channels=features * 2, down=False, act="relu", use_dropout=False)
        self.up5 = Block(in_channels=features * 2*2, out_channels=features, down=False, act="relu", use_dropout=False)
        # self.up6 = Block(in_channels=features * 2*2, out_channels=features , down=False, act="relu", use_dropout=False)
    ...
    def forward(self,x):
        ...
        final_up = self.final_up(torch.cat([u5,d1],dim=1))
        return final_up
...
if __name__ == '__main__':
    ...
    print(gen(x).shape)
    summary(gen,input_size=(1,3,128,128))
